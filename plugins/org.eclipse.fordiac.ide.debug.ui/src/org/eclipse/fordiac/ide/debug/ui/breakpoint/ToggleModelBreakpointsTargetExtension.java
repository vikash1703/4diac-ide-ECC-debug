...
@AdapterTypes(adaptableClass = { INamedElement.class, EditPart.class }, adapterNames = {
		IToggleBreakpointsTarget.class })
public class ToggleModelBreakpointsTargetExtension implements IToggleBreakpointsTargetExtension, IAdapterFactory {
